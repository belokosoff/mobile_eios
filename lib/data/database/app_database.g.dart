...
class $CacheEntriesTable extends CacheEntries
  ...
  @override
  List<GeneratedColumn> get $columns => [key, dataJson, updatedAt];
  @override
...
class CacheEntry extends DataClass implements Insertable<CacheEntry> {
  ...
  CacheEntry copyWith({String? key, String? dataJson, DateTime? updatedAt}) =>
      CacheEntry(
        key: key ?? this.key,
  ...
  @override
  int get hashCode => Object.hash(key, dataJson, updatedAt);
  @override
